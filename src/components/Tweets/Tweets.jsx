...
function Tweets({ tweet }) {
  ...
  <textarea
    className="flex-1 bg-transparent text-gray-800 p-3 font-medium text-lg focus:outline-none rounded-lg" style={window.innerWidth <= 400 ? { width: "400px" } : { width: "448px" }}
    rows="1"
