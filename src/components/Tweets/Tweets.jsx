...
function Tweets() {
  ...
  <div class="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl border max-w-xl">
    ...
    <p class="bg-gradient-to-r items-center from-blue-500 via-teal-500 to-pink-500 bg-clip-text dark:text-white block text-xl leading-snug mt-3">“No one ever made a decision because of a number. They need a story.” — Daniel Kahneman</p>
